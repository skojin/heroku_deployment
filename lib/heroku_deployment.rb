...
module HerokuDeployment
  class Rails
    ...
    def generate_css_and_js
      ...
      res = !!system(%(RAILS_ENV=development ./script/rails runner "Rails.cache.clear; ActionController::Base.perform_caching = true; ActionDispatch::Integration::Session.new(Rails.application).get '#{HerokuDeployment::Config.generate_url}'"))
